 ...
 <section id="property" class="padding_top padding_bottom_half">
               ...
               <div class="upper-box">
                   <div class="row">
                       <div class="col-lg-9 col-md-10 col-8 col-sm-8">
                           <div class="rating" data-aos="fade-up" data-aos-duration="1500">
                               ...
                               <span class="fa fa-star"></span>
                               <span class="fa fa-star"></span>
                               <?php echo e(App\Models\Testimonial::where("property_id",$data->id)->where("status","true")->count()); ?>+ Review
                           </div>
                           <h3 data-aos="fade-right" data-aos-duration="1500"><?php echo e($data->name); ?></h3> 
                            <div class="hotel-info" data-aos="fade-up" data-aos-duration="1500"><i class="fas fa-map-marker-alt"></i><?php echo e($data->address); ?></div>
                       </div>
                       <div class="col-lg-3 col-md-2 col-4 col-sm-4">
                            <div class="price">
                                <?php echo $setting_data['payment_currency']; ?><?php echo e($data->price); ?> <span>/ Day</span>
                            </div>
                       </div>
                   </div>
                    <ul class="food-list" data-aos="fade-up" data-aos-duration="1500" style="display:none;">
                       <li><i class="fa fa-bed" aria-hidden="true"></i>  <?php echo e($data->bedroom); ?> Bedrooms</li>
                       <li><i class="fa fa-bathtub" aria-hidden="true"></i>  <?php echo e($data->bathroom); ?> Bathrooms</li>
                       <li><i class="fa fa-users" aria-hidden="true"></i>  <?php echo e($data->sleeps); ?> Sleeps </li>
                   </ul>
               </div>
                                    ...
                                    <div class="col span_6 fwImage"style="text-align: center;">
                                       <div id="gallery-1" class="royalSlider rsDefault">
                                         ...
                                         <?php $__currentLoopData = App\Models\PropertyGallery::where("property_id",$data->id)->orderBy("sorting","asc")->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <a class="rsImg"   data-rsBigImg="<?php echo e(asset($c->image)); ?>" href="<?php echo e(asset($c->image)); ?>">
                                          <img width="126" height="82" class="rsTmb" src="<?php echo e(asset($c->image)); ?>" alt="<?php echo e($c->caption); ?>"/>
                                          <span><?php echo e($c->caption); ?></span>
                  ...
                  <div id="amenities" class="abouttext" style="margin-top: 30px;">
                     <div class="properties-amenities mb-30">
                        ...
                        <h4 style="font-size: 1.4rem;"><?php echo e($c->name); ?></h4>
                        <div class="row">
    ...
    <div class="col-lg-4" id="book">
       <div class="get-quote car-quote">
            <?php if($data->website): ?>
               <a href="<?php echo e($data->website); ?>" target="_BLANK">Book Now</a>
            <?php endif; ?>
        </div>
     </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("front.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/giffvacationpoolhomes/htdocs/www.giffvacationpoolhomes.com/projects/resources/views/front/property/car-single.blade.php ENDPATH**/ ?>