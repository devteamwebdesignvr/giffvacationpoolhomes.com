...
<?php $__env->startSection("container"); ?>
   ...
   <?php  $list=App\Models\Attraction::orderBy("id","desc")->paginate(10);?>  
                        ...
                        <div class="col-lg-5 col-md-12 col-sm-12 position-relative right-contentss">
                            <div class="inner-column-content">
                                <h3 data-aos="fade-left" data-aos-duration="1500">
                                  <a <?php if($c->type == "extremal"): ?> href="<?php echo e(url($c->extarnal_url)); ?>" <?php else: ?> href="<?php echo e(url('attractions/detail/'.$c->seo_url)); ?>" <?php endif; ?>><?php echo e($c->name); ?></a></h3>
                                <div class="line"></div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("front.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/giffvacationpoolhomes/htdocs/www.giffvacationpoolhomes.com/projects/resources/views/front/static/attractions.blade.php ENDPATH**/ ?>