...
<?php
    ...
    $list=$list->where(["isActive"=>"1","status"=>"true","location_id"=>$data->id])->orderBy("id","desc")->get();
?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("front.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/giffvacationpoolhomes/htdocs/www.giffvacationpoolhomes.com/projects/resources/views/front/property/location.blade.php ENDPATH**/ ?>