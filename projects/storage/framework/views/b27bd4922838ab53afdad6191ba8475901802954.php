<div class="row no-gutters">
    ...
    function getcolorData($date,$property){
        ...
        return 'red';
		        ...
		        $property=App\Models\HostFully\HostFullyProperty::Find(Request::get("id"));
		    ?>
		    <?php if($property): ?>
		    <?php
                $new_data_blocked=LiveCart::iCalDataCheckInCheckOut($property->uid);
			...
			<?php endif; ?>
		</div><?php /**PATH /home/giffvacationpoolhomes/htdocs/www.giffvacationpoolhomes.com/projects/resources/views/common-dates.blade.php ENDPATH**/ ?>