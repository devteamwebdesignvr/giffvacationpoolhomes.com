...
@section("container")
   ...
   @php  $list=App\Models\Attraction::orderBy("id","desc")->paginate(10);@endphp  
                        ...
                        <div class="col-lg-5 col-md-12 col-sm-12 position-relative right-contentss">
                            <div class="inner-column-content">
                                <h3 data-aos="fade-left" data-aos-duration="1500">
                                  <a @if($c->type == "extremal") href="{{ url($c->extarnal_url) }}" @else href="{{ url('attractions/detail/'.$c->seo_url) }}" @endif>{{$c->name}}</a></h3>
                                <div class="line"></div>
