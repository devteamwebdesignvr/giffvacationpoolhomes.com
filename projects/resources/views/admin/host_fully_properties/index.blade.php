...
@section('title', 'Admin')
@php 
    $name="Properties";$route="host_fully_properties";
@endphp            
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
          @php 
            $addbar=["name"=>$name,"add-data"=>false,"add-name"=>"Add ". Str::singular($name),"add-anchor"=>route($route.'.create'),"refresh-calander-data"=>"true","hostfully"=>true];
          @endphp
                ...
                <tbody>
                    ...
                    @foreach($data as $client)
                        <tr>
                             ...
                             <td> {{ $sno++ }}</td>
                             <td>{{App\Models\Location::find($client->location_id)->name ?? $client->location_id }}
                            <td>
                                {{ $client->name }}
                            </td>
                            <td>
