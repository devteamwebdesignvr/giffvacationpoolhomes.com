...
<div class="row">
    <div class="col-md-4">
        ...
        {!! Form::number("pet_fee",null,["class"=>"form-control"]) !!}
    </div>
    <div class="col-md-4">
        <label>Max Pet </label>
...
<div class="row">
    <div class="col-md-8">
        ...
        {!! Form::number("guest_fee",null,["class"=>"form-control"]) !!}
    </div>
    <div class="col-md-4">
...
@foreach(App\Models\PropertyFee::where("property_id",$data->id)->get() as $c)
    <div class="row gaurav-delete-property">
        ...
        <div class="col-md-2">
            {!! Form::number("fee_rate[]",$c->fee_rate,["required","class"=>"form-control","placeholder"=>"Fee Rate"]) !!}
        </div>
        <div class="col-md-2">
