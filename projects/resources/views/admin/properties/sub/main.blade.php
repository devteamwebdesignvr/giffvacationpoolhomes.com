<div class="row">
	...
	<div class="col-md-4 d-none ">
		<div class="form-group">
			...
			{!! Form::select("property_status",Helper::getPropertyStatus(),"car",["class"=>"form-control","placeholder"=>"Choose Property Status","required"]) !!}
...
<div class="row">
   ...
   @php  //put third party listing url only use for admin see @endphp
	<div class="col-md-12 ">
		<div class="form-group">
			{!! Form::label("car book now link") !!}
			{!! Form::text("website",null,["class"=>"form-control","placeholder"=>"Enter car book now link"]) !!}
