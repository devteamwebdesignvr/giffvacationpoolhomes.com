<div class="row">
   ...
   <div class="col-md-6">
        <div class="form-group">
            {!! Form::label("type*") !!}
            {!! Form::select("type",Helper::getAttractionType(),null,["class"=>"form-control","placeholder"=>"Choose Type","required"=>"required"]) !!}
            <span class="text-danger">{{ $errors->first("type") }}</span>
        </div>
    </div>
  <div class="col-md-6">
        <div class="form-group">
            {!! Form::label("extarnal_url") !!}
            {!! Form::text("extarnal_url",null,["class"=>"form-control"]) !!}
            <span class="text-danger">{{ $errors->first("extarnal_url")}}</span>
        </div>
    </div>
