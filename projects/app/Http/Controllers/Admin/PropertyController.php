        ...
        if($data){
            ...
            if($result){
                ...
                foreach(PropertyAmenityGroup::where("property_id",$id)->get() as $c){
                    ...
                    foreach(PropertyAmenity::where("property_amenity_id",$c->id)->get() as $c1){PropertyAmenity::create(["property_amenity_id"=>$am_group->id,"name"=>$c1->name,"status"=>$c1->status,"image"=>$c1->image,"sorting"=>$c1->sorting]);
                    }
                }
            }
